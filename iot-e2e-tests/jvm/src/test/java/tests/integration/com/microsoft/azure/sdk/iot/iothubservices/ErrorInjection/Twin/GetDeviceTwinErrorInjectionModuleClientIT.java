...
import com.microsoft.azure.sdk.iot.common.tests.iothubservices.GetDeviceTwinErrorInjectionTests;
...
public class GetDeviceTwinErrorInjectionModuleClientIT extends GetDeviceTwinErrorInjectionTests
{
    static String[] devicesToDeleteAfterTestClassFinishes;
    static String[][] modulesToDeleteAfterTestClassFinishes;

    public GetDeviceTwinErrorInjectionModuleClientIT(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
