...
import com.microsoft.azure.sdk.iot.common.tests.iothubservices.DesiredPropertiesTests;
...
public class DesiredPropertiesModuleClientIT extends DesiredPropertiesTests
{
    static String[] devicesToDeleteAfterTestClassFinishes;
    static String[][] modulesToDeleteAfterTestClassFinishes;

    public DesiredPropertiesModuleClientIT(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
