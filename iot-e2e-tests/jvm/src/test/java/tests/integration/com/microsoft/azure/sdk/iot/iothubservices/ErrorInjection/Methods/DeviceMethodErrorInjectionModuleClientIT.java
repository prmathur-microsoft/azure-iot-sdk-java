...
import com.microsoft.azure.sdk.iot.common.tests.iothubservices.DeviceMethodErrorInjectionTests;
...
public class DeviceMethodErrorInjectionModuleClientIT extends DeviceMethodErrorInjectionTests
{
    ...
    public DeviceMethodErrorInjectionModuleClientIT(DeviceTestManager deviceTestManager, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, Device device, Module module, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
    ...
    public static void cleanUpResources()
    {
        try
        {
            DeviceMethodCommon.tearDown(devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes, testManagers);
        }
        catch (Exception e)
        {
            e.printStackTrace();
