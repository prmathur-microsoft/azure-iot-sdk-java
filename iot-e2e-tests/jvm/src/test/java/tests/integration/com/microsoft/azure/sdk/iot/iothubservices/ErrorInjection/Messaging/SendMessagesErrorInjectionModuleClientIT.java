...
public class SendMessagesErrorInjectionModuleClientIT extends SendMessagesErrorInjectionTests
{
    static String[] devicesToDeleteAfterTestClassFinishes;
    static String[][] modulesToDeleteAfterTestClassFinishes;

    public SendMessagesErrorInjectionModuleClientIT(InternalClient client, IotHubClientProtocol protocol, Device device, AuthenticationType authenticationType, String clientType, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
    ...
    public static void cleanUpResources()
    {
        try
        {
            SendMessagesCommon.tearDown(devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes);
        }
        catch (Exception e)
        {
            e.printStackTrace();
