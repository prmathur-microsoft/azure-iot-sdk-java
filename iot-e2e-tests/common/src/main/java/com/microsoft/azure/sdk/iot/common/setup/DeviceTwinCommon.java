...
public class DeviceTwinCommon extends MethodNameLoggingIntegrationTest
{
    ...
    public static final long PERIODIC_WAIT_TIME_FOR_VERIFICATION = 100; // 0.1 sec
    public static final long MAX_WAIT_TIME_FOR_VERIFICATION = 60000; // 60 sec
    public static final long DELAY_BETWEEN_OPERATIONS = 200; // 0.2 sec

    public static final long MAXIMUM_TIME_FOR_IOTHUB_PROPAGATION_BETWEEN_DEVICE_SERVICE_CLIENTS = DELAY_BETWEEN_OPERATIONS * 10; // 2 sec

    //Max time to wait before timing out test
    public static final long MAX_MILLISECS_TIMEOUT_KILL_TEST = 120000; // 2 min

    // Max reported properties to be tested
    public static final Integer MAX_PROPERTIES_TO_TEST = 5;

    //Max devices to test
    public static final Integer MAX_DEVICES = 3;
    ...
    public static final String PROPERTY_KEY_QUERY = "KeyQuery";
    public static final String PROPERTY_VALUE = "Value";
    public static final String PROPERTY_VALUE_QUERY = "ValueQuery";
    public static final String PROPERTY_VALUE_UPDATE = "Update";
    public static final String PROPERTY_VALUE_UPDATE2 = "Update2";
    public static final String TAG_KEY = "Tag_Key";
    public static final String TAG_VALUE = "Tag_Value";
    public static final String TAG_VALUE_UPDATE = "Tag_Value_Update";

    // States of SDK
    public static RegistryManager registryManager;
    public static InternalClient internalClient;
    public static RawTwinQuery scRawTwinQueryClient;
    public static DeviceTwin sCDeviceTwin;
    public static DeviceState deviceUnderTest = null;

    public static DeviceState[] devicesUnderTest;

    public DeviceTwinCommon.DeviceTwinITRunner testInstance;
    ...
    public void addMultipleDevices(int numberOfDevices) throws IOException, InterruptedException, IotHubException, NoSuchAlgorithmException, URISyntaxException, ModuleClientException
    {
    ...
    public void removeMultipleDevices(int numberOfDevices) throws IOException, IotHubException, InterruptedException
    {
        for (int i = 0; i < numberOfDevices; i++)
        {
    ...
    public void setUpTwin(DeviceState deviceState) throws IOException, URISyntaxException, IotHubException, InterruptedException, ModuleClientException
    {
    ...
    public static Collection inputsCommon(ClientType clientType, String publicKeyCert, String privateKey, String x509Thumbprint) throws IOException
    {
        ...
        String[][] modulesToDeleteAfterTestClassFinishes = new String[][] {};
                    ...
                    new Object[][]
                            {
                                    ...
                                    {deviceIdAmqps, moduleIdAmqps, AMQPS, SAS, "ModuleClient", devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes, publicKeyCert, privateKey, x509Thumbprint},
                                    {deviceIdAmqpsWs, moduleIdAmqpsWs, AMQPS_WS, SAS, "ModuleClient", devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes, publicKeyCert, privateKey, x509Thumbprint},
                                    {deviceIdMqtt, moduleIdMqtt, MQTT, SAS, "ModuleClient", devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes, publicKeyCert, privateKey, x509Thumbprint},
                                    {deviceIdMqttWs,  moduleIdMqttWs, MQTT_WS, SAS, "ModuleClient", devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes, publicKeyCert, privateKey, x509Thumbprint}
                            }
            );
        }
    ...
    public DeviceTwinCommon(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
        this.testInstance = new DeviceTwinCommon.DeviceTwinITRunner(deviceId, moduleId, protocol, authenticationType, clientType, devicesToDeleteAfterTestClassFinishes, modulesToDeleteAfterTestClassFinishes, publicKeyCert, privateKey, x509Thumbprint);
    }

    public class DeviceTwinITRunner
    {
        ...
        public DeviceTwinITRunner(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
        {
    ...
    public void readReportedPropertiesAndVerify(DeviceState deviceState, String startsWithKey, String startsWithValue, int expectedReportedPropCount) throws IOException, IotHubException, InterruptedException
    {
        int actualCount = 0;
    ...
    public void waitAndVerifyTwinStatusBecomesSuccess() throws InterruptedException
    {
        // Check status periodically for success or until timeout
        long startTime = System.currentTimeMillis();
        long timeElapsed = 0;
    ...
    public void waitAndVerifyDesiredPropertyCallback(String propPrefix, boolean withVersion) throws InterruptedException
    {
        // Check status periodically for success or until timeout
        long startTime = System.currentTimeMillis();
        long timeElapsed = 0;
    ...
    public void subscribeToDesiredPropertiesAndVerify(int numOfProp) throws IOException, InterruptedException, IotHubException
    {
        // arrange
