...
public class DeviceMethodITonAndroid extends DeviceMethodTests
{
    ...
    public static Collection inputsCommons() throws IOException, IotHubException, GeneralSecurityException, URISyntaxException, InterruptedException, ModuleClientException
    {
        ...
        return DeviceMethodTests.inputsCommon(ClientType.DEVICE_CLIENT);
    }

    public DeviceMethodITonAndroid(DeviceTestManager deviceTestManager, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, Device device, Module module, String uuid)
    {
        super(deviceTestManager, protocol, authenticationType, clientType, device, module, uuid);
    }
}
