...
import com.microsoft.azure.sdk.iot.common.tests.iothubservices.GetDeviceTwinTests;
...
public class GetDeviceTwinITonAndroid extends GetDeviceTwinTests
{
    ...
    public GetDeviceTwinITonAndroid(String deviceId, String moduleId, IotHubClientProtocol protocol, AuthenticationType authenticationType, String clientType, String[] devicesToDeleteAfterTestClassFinishes, String[][] modulesToDeleteAfterTestClassFinishes, String publicKeyCert, String privateKey, String x509Thumbprint)
    {
